...
const UserCaseContainer = ({image, headerText, children, className, ...others}) => {
  return (
    <React.Fragment>
      <section className={`user-case-container d-flex align-items-start flex-column ${className} p-4 `} {...others}>
